...
- 新增遊戲結束視窗動畫
- 已知 bug
  - 換成冰凍了，冰凍時翻滾有機率造成玩家永久加速或減速
  - 通過第五關難度加倍後，若按"Restart"重新開始關卡，難度仍保持兩倍沒有重置(按"Exit"或輸掉重進時正常)
  - 召喚小怪時有機率卡在邊界外/河裡
- 修復 bug
  - 修復撿起道具時動畫低機率卡住的問題
  - 修復有時無法放下手上道具的問題
...
- 建立有技能的敵人Resource，可直接使用或自行修改
  ...
  - 12:復活惡魔(死亡觸發)
- 增加治癒/緩速/復活效果至Ch2關卡
  - 原本要放召喚但會卡死，所以改成放復活在Lv10，並減少了幾隻怪物
  - 測試過不太影響平衡，但有空的話還是幫忙測一次
- Ch1、Ch2已全數完成，若要測試怪物技能請至Ch3
- 已知bug
  - 在緩速效果時翻滾有機率造成玩家永久加速或減速
  - 攻擊不一定會觸發中毒效果
